...
class KLGMMLossLayerTest : public MultiDeviceTest<TypeParam> {
 ...
 protected:
  KLGMMLossLayerTest()
	  ...
	  blob_bottom5_(new Blob<Dtype>(3, 12, 1, 1)),
	  blob_bottom6_(new Blob<Dtype>(3, 12, 1, 1)),
	...
	filler2.Fill(this->blob_bottom5_);
	filler1.Fill(this->blob_bottom6_);
  ...
  Blob<Dtype>* const blob_bottom6_;
  Blob<Dtype>* const blob_top_;
  vector<Blob<Dtype>*> blob_bottom_vec_;
  vector<Blob<Dtype>*> blob_top_vec_;
};

TYPED_TEST_CASE(KLGMMLossLayerTest, TestDtypesAndDevices);

TYPED_TEST(KLGMMLossLayerTest, TestGradient) {
  typedef typename TypeParam::Dtype Dtype;
